...
const Project1 = () => {
    ...
    const projectContent = [
        ...
        {img:'/assets/images/portfolio/portfolio_4_0.png', subtitle:'Article', title:'Prediction using Supervised Machine Learning (ML) with Python Implementation - Linear Regression', id: '4'}
      ];   
